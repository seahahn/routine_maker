...
class ChatroomsAdapterItemMoveCallback : ItemTouchHelper.Callback() {
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder): View {
        return (viewHolder as ChatroomsAdapter.ChatRoomViewHolder).itemView.findViewById(R.id.item)
    }
