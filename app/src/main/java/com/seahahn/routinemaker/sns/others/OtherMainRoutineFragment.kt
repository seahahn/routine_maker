...
class OtherMainRoutineFragment : Fragment(), CompoundButton.OnCheckedChangeListener, View.OnClickListener {
...
//        d(TAG, "rt fragment onViewCreated")
        ...
        showAll.visibility = View.GONE // 전체 목록 보기 체크박스 숨기기
//        showAll.setOnCheckedChangeListener(this)

        deleteDone = view.findViewById(R.id.deleteDone)
        deleteDone.visibility = View.GONE // 완료한 할 일 삭제하기 버튼 숨기기
